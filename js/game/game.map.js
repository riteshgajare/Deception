window.game.map = function() {
  var _map = {
    ...
    getMap2: function(){
      _map.create_block(-85,15,-5, 100,5,30,_texture.normalBlue);
      _map.create_block(-500,15,-5, 100,5,30,_texture.normalBlue);
      _map.create_block(-900,45,-5, 100,5,30,_texture.normalBlue);
      _map.create_block(-900,-45,-5,100,5,30,_texture.normalBlue);
      _map.create_block(-1300,-15,-5,100,5,30,_texture.normalBlue);
      _map.create_block(-1700,65,-5,100,5,30,_texture.normalBlue);
      _map.create_block(-2100,-15,5,100,10,30,_texture.normalBlue);
      _map.create_block(-2500,-15,5,100,10,30,_texture.normalBlue);
      _map.create_block(-2900,-45,5,100,10,30,_texture.normalBlue);
      _map.create_block(-3300,-15,5,100,10,30,_texture.normalBlue);
      _map.create_block(-3700,-40,5,100,5,15,_texture.red,true);
      _map.create_block(-3700,10,0,100,5,15,_texture.normalBlue);
      _map.create_block(-4100,-40,-5,100,5,15,_texture.normalBlue);
      _map.create_block(-4100,10,0,100,5,15,_texture.red,true);

      // start at -4500 and 400 add
      _map.create_block(-4500,15,-5, 100,5,30,_texture.normalBlue);
      _map.create_block(-4900,-70,-5,100,5,15,_texture.normalBlue);
      _map.create_block(-5300,-70,-5,100,5,15,_texture.normalBlue);
      _map.create_block(-5700,-70,-5,100,5,15,_texture.normalBlue);
      _map.create_block(-6100,-10,0,100,10,30,_texture.gray);
      // close
      _map.create_block(-6400,-10,0,100,10,30,_texture.gray);
      _map.create_block(-6700,-10,5,100,10,30,_texture.gray);
      _map.create_block(-7000,-10,15,100,10,30,_texture.gray);
      _map.create_block(-7300,-10,25,100,10,30,_texture.gray);
      _map.create_block(-7800,-10,0,100,10,30,_texture.gray);
